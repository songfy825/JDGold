...
public class Config {
    public static final String DB_URL_MS = "jdbc:sqlite:./data/Transaction_MS.db"; //民生银行
    public static final String DB_URL_ZS = "jdbc:sqlite:./data/Transaction_ZS.db"; //浙商银行
    public static final String DB_URL_GS = "jdbc:sqlite:./data/Transaction_GS.db"; //工商银行
